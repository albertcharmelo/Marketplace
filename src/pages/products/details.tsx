...
const details = () => {
  return (
    <div>
                  ...
                  <ul
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        aria-selected="true">
                        <img
                          src="/assets/img/shop/product/details/product-nav-1.jpg"
                          alt=""
                        />
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        aria-selected="false">
                        <img
                          src="/assets/img/shop/product/details/product-nav-2.jpg"
                          alt=""
                        />
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        aria-selected="false">
                        <img
                          src="/assets/img/shop/product/details/product-nav-3.jpg"
                          alt=""
                        />
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        aria-selected="false">
                        <img
                          src="/assets/img/shop/product/details/product-nav-4.jpg"
                          alt=""
                        />
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        id="thumbFive-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#thumbFive"
                        type="button"
                        role="tab"
                        aria-controls="thumbFive"
                        aria-selected="false">
                        <img
                          src="/assets/img/shop/product/details/product-nav-5.jpg"
                          alt=""
                        />
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        id="thumbSix-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#thumbSix"
                        type="button"
                        role="tab"
                        aria-controls="thumbSix"
                        aria-selected="false">
                        <img
                          src="/assets/img/shop/product/details/product-nav-6.jpg"
                          alt=""
                        />
                      </button>
                    </li>
                    ...
                    <div className="tab-content" id="productThumbContent">
                      <div
                        ...
                        <div className="product__details-nav-thumb">
                          <img
                            src="/assets/img/shop/product/details/big/product-nav-big-1.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                      <div
                        ...
                        <div className="product__details-nav-thumb">
                          <img
                            src="/assets/img/shop/product/details/big/product-nav-big-2.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                      <div
                        ...
                        <div className="product__details-nav-thumb">
                          <img
                            src="/assets/img/shop/product/details/big/product-nav-big-3.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                      <div
                        ...
                        <div className="product__details-nav-thumb">
                          <img
                            src="/assets/img/shop/product/details/big/product-nav-big-4.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                      <div
                        ...
                        <div className="product__details-nav-thumb">
                          <img
                            src="/assets/img/shop/product/details/big/product-nav-big-5.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                      <div
                        ...
                        <div className="product__details-nav-thumb">
                          <img
                            src="/assets/img/shop/product/details/big/product-nav-big-6.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                ...
                <div className="product__details-wrapper">
                  <div className="product__details">
                    <h3 className="product__details-title">
                      <a href="product-details.html">
                        Smart Mobile Phone 7/7plus/8/8plus/X/Xr W 32 to 128GB
                      </a>
                    </h3>
                    ...
                    <div className="product__details-des mb-30">
                      <p>
                        ...
                        saepius. Claritas est etiam processus. Lorem Ipsum has
                        been the industry's standard dummy text ever since the
                        1500s, when anunknown printer took a galley of type and
                  ...
                  <div
                    ...
                    <div className="product__details-des-wrapper">
                      ...
                      <div className="product__details-des-banner w-img">
                        <img
                          src="/assets/img/shop/product/details/product-details-banner.jpg"
                          alt=""
                        />
                      </div>
                    </div>
                      ...
                      <div className="row">
                            ...
                            <div className="review-item">
                              ...
                              <div className="review-text">
                                <p>
                                  ...
                                  adipisicing elit. Corrupti quia eligendi
                                  molestias illum libero et.
                                </p>
                              </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                          <div className="review-form">
                            ...
                            <p>
                              Australian Certified Organic Royal Gala Apples
                            </p>
                            <form action="#">
                            ...
                            <div className="footer__info footer__info-4">
                              <ul>
                                ...
                                <li>
                                  <span>
                                    Email:{" "}
                                    <a href="mailto:info@thebuesky.com">
                                      info@thebuesky.com
                                    </a>
                                  </span>
                                </li>
                      ...
                      <div className="footer__widget">
                        ...
                        <div className="footer__widget-content">
                          <div className="footer__subscribe">
                            <p>
                              {" "}
                              <span>Join 40.00+ Subscribers</span> and get a new
              ...
              <div className="row align-items-center">
                <div className="col-xl-6 col-lg-6">
                  <div className="footer__copyright-text footer__copyright-text-2">
                    <p>
                      Copyright © <a href="index.html">Topico.</a> All Rights
                      Reserved. <a href="#">ThemePure.</a>
                    </p>
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6">
      ...
      <Script
        src="/assets/js/jquery-ui-slider-range.js"
        strategy="lazyOnload"
      />
